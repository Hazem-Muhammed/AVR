...
void lcd_sendCmd(lcd_Cmd_Type cmd){
		...
		dio_vidWriteChannel(DataPort,D4PIN,(GET_BIT(cmd,4)));
		dio_vidWriteChannel(DataPort,D5PIN,(GET_BIT(cmd,5)));
		dio_vidWriteChannel(DataPort,D6PIN,(GET_BIT(cmd,6)));
		dio_vidWriteChannel(DataPort,D7PIN,(GET_BIT(cmd,7)));
		...
		dio_vidWriteChannel(DataPort,D4PIN,(GET_BIT(cmd,0)));
		dio_vidWriteChannel(DataPort,D5PIN,(GET_BIT(cmd,1)));
		dio_vidWriteChannel(DataPort,D6PIN,(GET_BIT(cmd,2)));
		dio_vidWriteChannel(DataPort,D7PIN,(GET_BIT(cmd,3)));
		dio_vidWriteChannel(CommandPort,EPIN,STD_HIGH);
		_delay_us(1);
		dio_vidWriteChannel(CommandPort,EPIN,STD_LOW);
...
void lcd_sendData(u8 data){
		...
		//Sending Higher nibble to Data Port
		dio_vidWriteChannel(DataPort,D4PIN,(GET_BIT(data,4)));
		dio_vidWriteChannel(DataPort,D5PIN,(GET_BIT(data,5)));
		dio_vidWriteChannel(DataPort,D6PIN,(GET_BIT(data,6)));
		dio_vidWriteChannel(DataPort,D7PIN,(GET_BIT(data,7)));
		dio_vidWriteChannel(CommandPort,EPIN,STD_HIGH);
		_delay_us(1);
		dio_vidWriteChannel(CommandPort,EPIN,STD_LOW);
		//Sending Lower nibble to Data Port
		dio_vidWriteChannel(DataPort,D4PIN,(GET_BIT(data,0)));
		dio_vidWriteChannel(DataPort,D5PIN,(GET_BIT(data,1)));
		dio_vidWriteChannel(DataPort,D6PIN,(GET_BIT(data,2)));
		dio_vidWriteChannel(DataPort,D7PIN,(GET_BIT(data,3)));
		dio_vidWriteChannel(CommandPort,EPIN,STD_HIGH);
		_delay_us(1);
		dio_vidWriteChannel(CommandPort,EPIN,STD_LOW);
		//Busy wait to allow LCD to process the command
